...
if ( class_exists( 'WP_Customize_Control' ) ) {
	...
	/**
	 * Hello_Pro_Toggle_Control creates a custom On/Off toggle switch to replace HTML checkboxes.
	 *
	 * @var string $type The type of colors to use - light or dark.
	 * @access public
	 */
	class Hello_Pro_Toggle_Control extends WP_Customize_Control {
		/**
		...
		public function enqueue() {
			wp_enqueue_style( genesis_get_theme_handle() . '-toggle-control-css', get_stylesheet_directory_uri() . '/lib/customizer/hello-pro-toggle-control.css', array(), genesis_get_theme_version() );
			$css = '
